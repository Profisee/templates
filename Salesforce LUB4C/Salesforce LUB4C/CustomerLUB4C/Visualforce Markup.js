...
<apex:page standardController="Account" showheader="true">
    ...
    <script type="text/javascript">
        ...
        function lookUpMember() {
           ...
           // var ajaxURL = "https://ProfVM65Integr.eastus2.cloudapp.azure.com/SalesforceLUB4C/Customer/LookupBeforeCreate";
            var ajaxURL = "http://127.0.0.1/SalesforceLUB4C/Customer/LookupBeforeCreate";
            ...
            j$.ajax({
                ...
                if (msg == undefined || msg == "") {
                    ...
                    var tbody = parseResultIntoHtmlTable(msg.Matches);
...
//            var tbody = parseResultIntoHtmlTable(results.Matches);
//            var table = j$(".search-results").find("tbody");
//            table.html(tbody);
//            j$(".search-results").show();
//            j$(".create-new-button").show();
